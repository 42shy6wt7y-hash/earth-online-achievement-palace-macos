...
Write-Utf8NoBomLf (Join-Path $payload "README-macOS.txt") @(
  ...
  '10. 想以后更方便，就把“地球online成就殿堂.app”从“下载”拖到 Finder 左边的“应用程序”。'
  '11. 以后可以从“应用程序”或 Launchpad 打开。'
  ''
  '如果没有看到“仍要打开”：'
  '不同 macOS 版本的位置可能略有差异。可以直接打开“系统设置 - 隐私与安全性”，在页面底部附近寻找“地球online成就殿堂”的拦截记录，再点击“仍要打开”。'
  ''
  '备用启动：'
